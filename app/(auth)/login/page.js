  ...
  return (
    <div className="card shadow-xl border-white/10 overflow-hidden">
      <div className="card-header border-b border-white/5 text-center pt-8 pb-6">
        ...
        <p className="text-zinc-400 text-sm mt-2">Sign in to access your apps and credits</p>
      </div>
      ...
      <div className="card-footer bg-black/20 text-center py-4 border-t border-white/5">
        <p className="text-sm text-zinc-400">
          Don't have an account? <Link href="/signup" className="text-white font-medium hover:text-indigo-400 transition-colors">Sign up for free</Link>
        </p>
      </div>
    </div>
  );
